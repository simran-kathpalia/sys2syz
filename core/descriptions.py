...
class Descriptions(object):
    ...
    def build_ptr(self, child, default_name=None):
        ...
        try:
            ...
            if "base-type-builtin" in child.attrib.keys():
                ...
                if base_type =="void":
                    ptr_str = "ptr[" + "in" + ", array[int8]]"

                else:
                    ptr_str = "ptr[" + "in" + ", " + str(type_dict[child.get("base-type-builtin")]) + "]"
    ...
    def make_file(self):
        ...
        try:
            ...
            os.popen('cd $HOME/freebsd-src/sys/')
            outttt = os.popen('find -name "mdioctl.h"')
            in_path = outttt.read()
            print(in_path)
            ...
            if func_descriptions is not None:
                desc_buf = "# Copyright 2021 syzkaller project authors. All rights reserved.\n# Use of this source code is governed by Apache 2 LICENSE that can be found in the LICENSE file.\n# Autogenerated by sys2syz\n\n"
            ...
            if self.ptr_dir != "null":
                ...
                if argument_name in type_dict.keys():
                    ...
                    if raw_arg is not None:
                        ...
                        self.arguments[cmd] = arg_str
            #for IO_, IOWINT_ ioctls as they don't have any arguments
            else:
